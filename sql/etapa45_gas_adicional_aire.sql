...
--
--   El kilo va a 49 €. El gas se compra a 49,64 con descuento ya aplicado, así
--   que ese precio se deja tal cual, sin recargo: el material de la recarga y
--   el trabajo van en el C104 (450 € por unidad interior).
-- ---------------------------------------------------------------------------
create temporary table precio_gas on commit drop as select 49.00::numeric as eur_kg;
