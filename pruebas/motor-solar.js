...
var partidas = {
  KIT_BASE: { codigo: 'KIT_BASE', nombre: 'Kit base instalación fotovoltaica', items: [
    ...
    { concepto_libre: 'Mano de obra', precio_fijo: 725, formula_cantidad: '1', orden: 3 },
...
// OJO: los siete renglones que sembró la etapa 38 suman 3.742 €, no los 5.445 €
// que dice el briefing. Faltan 1.703 € sin desglosar. Mientras no se aclare, la
// prueba fija lo que de verdad hay en la base, para que el día que se corrija
// esto cante.
igual('total con el kit tal como está sembrado', eur2(total(r)), eur2(3742 + 1610 + 110 * 10));
print('  info  el kit de 5–6 kWp sembrado suma 3.742 €; el análisis decía 5.445 €. Faltan 1.703 € por desglosar.');
...
igual('total', eur2(total(r)), eur2(8560 + 2100 + 110 * 20));
...
igual('sigue en el kit pequeño', eur2(total(r)), eur2(3742 + 1610 + 110 * 12));
...
igual('7,14 kWp → kit de 10', eur2(total(r)), eur2(8560 + 2100 + 110 * 14));
...
igual('total, solo paneles', eur2(total(r)), eur2(110 * 40));
